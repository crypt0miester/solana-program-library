...
pub fn create_asset<'a>(input: CreateAssetHelperArgs<'a>, payer: Pubkey) -> Instruction {
    CreateV2Builder::new()
        .asset(*input.asset)
        .collection(input.collection)
        .authority(input.authority)
        .payer(payer)
        .owner(Some(input.owner.unwrap_or(payer)))
...
pub fn create_collection<'a>(input: CreateCollectionHelperArgs<'a>, payer: Pubkey) -> Instruction {
