...
use {
    ...
    p_spl_governance_tools::account::create_and_serialize_account_signed,
    pinocchio::{
...
pub fn process_cast_vote(
    ...
    let voter_token_owner_record_info_data =
        unsafe { voter_token_owner_record_info.borrow_mut_data_unchecked() };
    voter_token_owner_record_data.serialize(voter_token_owner_record_info_data)?;
