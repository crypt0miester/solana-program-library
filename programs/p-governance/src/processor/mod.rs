...
pub fn process_instruction(
    ...
    log!("VERSION:{}", env!("CARGO_PKG_VERSION"));
    let instruction = GovernanceInstruction::try_from(input)?;
    ...
    match instruction {
        ...
        GovernanceInstruction::FlagVersionedTransactionError {} => {
            process_flag_versioned_transaction_error(program_id, accounts)
        }
    }
}
