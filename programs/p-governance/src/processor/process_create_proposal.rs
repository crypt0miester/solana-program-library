...
use {
    ...
    }, p_spl_governance_addin_api::voter_weight::VoterWeightAction, p_spl_governance_tools::account::create_and_serialize_account_signed, pinocchio::{
...
pub fn process_create_proposal(
    ...
    proposal_owner_record_data.outstanding_proposal_count = proposal_owner_record_data
        ...
        .checked_add(1)
        .unwrap();
    let proposal_owner_record_info_data = unsafe { proposal_owner_record_info.borrow_mut_data_unchecked() };
    ...
    unsafe { governance_data.serialize_as_governance_v2(governance_info, payer_info, system_info, &rent)?; }
