...
use {
    p_spl_governance_tools::account::{AccountMaxSize, DataLen, IsInitialized},
    pinocchio::{pubkey::Pubkey, sysvars::clock::Slot},
};
...
impl DataLen for MaxVoterWeightRecord {
    const LEN: usize = core::mem::size_of::<MaxVoterWeightRecord>();
}
