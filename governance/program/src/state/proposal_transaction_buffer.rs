...
use {
    ...
    solana_program::{
        account_info::AccountInfo, hash::hashv, program_error::ProgramError,
...
/// This account will be closed once it gets transformed into ProposalVersionedTransaction
...
/// Deserializes ProposalTransactionBuffer and validates it belongs to the given Governance
